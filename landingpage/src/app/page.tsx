    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <section id="home" className="flex min-h-screen flex-col items-center justify-center px-6 pt-16 text-center">
        ...
        <p className="mt-6 max-w-xl text-lg text-muted">
          DOT Delivery connects you with local groceries and everyday essentials across Victoria. Browse by category, search products, or ask DOTBOT by voice—then checkout with secure payment and track your order until it arrives.
        </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { step: "2", title: "Browse or ask DOTBOT", text: "Shop by category or search. Prefer hands-free? Tell DOTBOT what you need by voice or text and it adds items to your cart." },
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: "DOTBOT assistant", description: "Add items by voice or text. Say or type what you need—DOTBOT finds matching products and adds them to your cart. Hands-free and fast for repeat orders." },
              ...
              { title: "Drive with DOT", description: "Join as a delivery partner. See available orders, accept assignments, and complete deliveries. Separate driver app—DOTDRIVER—for delivery partners." },
            ].map((item) => (
              <div
                key={item.title}
      ...
      <section className="border-t border-black/5 bg-foreground/[0.02] py-16">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-3 text-muted">
            DOT Delivery operates within Victoria. We connect you with local grocery and product options and independent delivery partners. Estimated delivery times and fees are shown at checkout.
          </p>
        </div>
      </section>
      ...
      <section id="about" className="border-t border-black/5 py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-muted">
            DOT Delivery is a technology platform that connects customers with local groceries and essentials in Victoria. We don’t own or store the products—we link you with partner stores and delivery drivers so you can order in the app, pay securely, and get your order at your door. Our focus is a simple experience: set your location, browse or ask DOTBOT, checkout, and track your delivery.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <dl className="mt-12 space-y-8">
            {[
              ...
              { q: "What is DOTBOT?", a: "DOTBOT is our in-app assistant. You can speak or type what you want to buy, and DOTBOT finds matching products and adds them to your cart. It’s optional—you can always browse and tap to add items yourself." },
            ].map(({ q, a }) => (
              <div key={q}>
      ...
      >
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <p className="mt-3 text-muted">
            Download DOT Delivery to start ordering. Enter your email and we’ll send you the link.
          </p>
